...
class DB extends PDO {
	...
	public static $_aParams = array(
							...
							'dbname' => 'itfanis',		// Имя базы данных MySQL
	...
	/**
	 *  Защищенное статическое свойство, в котором хранится статус наличия созданного экземпляра объекта нашего класса
	 */
	...
	protected function _connect() {
		 ...
		 * и дополнительные параметры подключения
		 *
